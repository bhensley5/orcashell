...
impl OrcaTheme {
    pub fn dark() -> Self {
        Self {
            ...
            SHADOW: 0x06080C,
            ANSI: [
                0x0A0C10, 0xFF7E9D, 0x7EFFC1, 0xFFD97E, 0x5E9BFF, 0xB87EFF, 0x7EE8FA, 0xD8DAE0,
                0x5C6070, 0xFFA0B8, 0xA0FFD6, 0xFFE5A0, 0x82B4FF, 0xCCA0FF, 0xA0F0FF, 0xE8EAF0,
            ],
    ...
    pub fn black() -> Self {
        Self {
            ...
            SHADOW: 0x000000,
            ANSI: [
                0x000000, 0xFF8AA5, 0x89FFC8, 0xFFE08F, 0x6AA7FF, 0xC08AFF, 0x88EDFF, 0xE1E6EF,
                0x596274, 0xFFACC0, 0xADFFD9, 0xFFEAB1, 0x90BDFF, 0xD2AEFF, 0xAEF3FF, 0xF1F4FA,
            ],
            WIN_CLOSE_HOVER: 0xE81123,
    ...
    pub fn light() -> Self {
        Self {
            ...
            SHADOW: 0xB8C2CF,
            ANSI: [
                0x263241, 0xC95E79, 0x2D8F69, 0xA67621, 0x3F78DE, 0x8C67D4, 0x257E78, 0xBBC5D3,
                0x5B687C, 0xDE7F97, 0x53AD86, 0xC59745, 0x6897EB, 0xAB84E3, 0x4CABBA, 0xE2E8F1,
            ],
            WIN_CLOSE_HOVER: 0xE81123,
    ...
    pub fn sepia() -> Self {
        Self {
            ...
            SHADOW: 0xA79378,
            ANSI: [
                0x47382A, 0xBF715E, 0x64895A, 0xB48636, 0x5A82AD, 0x8B6FAF, 0x4A8D80, 0xC8B79F,
                0x72604D, 0xD28B78, 0x87A27D, 0xC9A158, 0x7A9BC1, 0xA58AC7, 0x6AA79A, 0xE8DCC5,
            ],
            WIN_CLOSE_HOVER: 0xE81123,
